...
RSpec.describe Event, type: :model do
  ...
  it 'belongs to a user' do
    ...
    event = build(:event, user: user)  # Assuming you have a valid event factory
  ...
  it "calculates start_datetime correctly" do
    event = build(:event, user: user, start_date: '2023-11-06', start_time: '10:00 AM')  # Corrected time format
  ...
  it "calculates end_datetime correctly" do
    event = build(:event, user: user, end_date: '2023-11-06', end_time: '11:00 AM')  # Corrected time format
