...
RSpec.feature 'Pages Post', type: :feature do
  describe 'Pages Post' do
    ...
    it 'should open the page form and save to db if all validation passed & create the post for page' do
