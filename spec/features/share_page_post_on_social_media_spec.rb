...
RSpec.feature 'Share the Page Post on social media', type: :feature do
  describe 'Share the Page Post on social media' do
    ...
    it 'should open the page post form and save to db if all validation passed & share the group post on social media (facebook)  ' do
      ...
      click_link 'page_facebook_share', wait: 10
    end

    it 'should open the page post form and save to db if all validation passed & share the group post on social media (twitter)  ' do
      ...
      find('#dropdownMenuButton1').click
      click_link 'page_twitter_share', wait: 10
    end
  end
end
