...
RSpec.feature 'Share the Group Post on social media', type: :feature do
  describe 'Share the Group Post on social media' do
    ...
    it 'should open the group post form and save to db if all validation passed & share the group post on social media (facebook) ' do
      ...
      click_link 'group_facebook_share', wait: 10
    end

     it 'should open the group post form and save to db if all validation passed & share the group post on social media (twitter) ' do
        ...
        find('#dropdownMenuButton1').click
        click_link 'group_twitter_share', wait: 10
        sleep 3
      end
  end
end
